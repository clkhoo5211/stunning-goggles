...
import "./chunk-OPVTMSOY.js";
import {
  require_browser,
  require_fast_safe_stringify,
  require_semver
} from "./chunk-JLP24LWE.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-ESHKDWV6.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-QABAG5PU.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-6SGU4EJV.js");
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-L363WR23.js");
          return Porto.create({
            ...parameters,
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-DI564XWV.js");
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=exports-DJOMON42.js.map
