...
function pointG2ToBytes(_c, point, isComp) {
  ...
  if (isComp) {
    if (is0)
      return concatBytes(COMPZERO, numberToBytesBE(_0n4, L));
...
function signatureG2FromBytes(hex) {
  ...
  const is0 = y1 === _0n4 && y0 * _2n4 / P !== aflag1;
  if (isGreater || is0)
    y = Fp2.neg(y);
  const point = Point2.fromAffine({ x, y });
  point.assertValidity();
...
var HDKey = class _HDKey {
  ...
  static fromMasterSeed(seed, versions = BITCOIN_VERSIONS) {
    ...
    const I = hmac(sha5123, MASTER_SECRET, seed);
    return new _HDKey({
      versions,
  ...
  deriveChild(index2) {
    ...
    const I = hmac(sha5123, this.chainCode, data);
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-PPHF35PC.js.map
