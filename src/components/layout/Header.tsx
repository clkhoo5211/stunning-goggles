...
import { Wallet, Home, Gamepad2, History, Trophy, Shield, User } from 'lucide-react';
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-shrink-0">
            {isConnected && address ? (
              ...
              >
                ...
                <span className="hidden sm:inline font-mono text-green-300">{formatAddress(address)}</span>
                <span className="sm:hidden font-mono text-green-300 text-xs">{address.slice(0, 4)}...</span>
              </button>
            ) : (
              <button
                onClick={handleConnect}
